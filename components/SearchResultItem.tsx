  ...
  return (
    <article className="flex gap-4 border-b border-slate-200 bg-white p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex items-start"><span className="mt-1 text-xs">$</span><span className="text-2xl font-semibold">{product.price.toFixed(2).split(".")[0]}</span><sup className="mt-1">{product.price.toFixed(2).split(".")[1]}</sup></div>
